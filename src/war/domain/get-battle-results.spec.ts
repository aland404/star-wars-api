import {LocationEntity, TroopEntity} from "../infrastructure/entities";
import {getBattleResults} from "./get-battle-results";
import {Faction, Kind, People} from "../../people/domain/people";

describe("UNIT | getBattleResults", function () {
    describe("with no troop", function () {
    ...
    describe("with one troop", function () {
        it("should return the one troop as winner and no loser", function () {
    ...
    describe("with several troops", function () {
        it("empire should win and rebellion loose", function () {
        ...
        it("empire should loose and rebellion win", function () {
            const battle = getBattleEntity([
                {
                    slug: "",
                    people: {
